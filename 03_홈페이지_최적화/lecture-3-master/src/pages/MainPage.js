...
function MainPage(props) {
    const itemsRef = useLazyImageLoad()
    const partsRef = useLazyImageLoad()
    const stylesRef = useLazyImageLoad()
    return (
                ...
                <TwoColumns
                    ...
                    columns={ [
                        <picture>
                            ...
                            <img data-src={ main_items } ref={ itemsRef } />
                        </picture>,
                        <Meta
                            title={ 'Items' }
                ...
                <TwoColumns
                    ...
                    columns={ [
                        ...
                        <picture>
                            ...
                            <img data-src={ main_parts } ref={ partsRef } />
                        </picture>
                    ] }
                    mobileReverse={ true }
                />
                <TwoColumns
                    ...
                    columns={ [
                        <picture>
                            ...
                            <img data-src={ main_styles } ref={ stylesRef } />
                        </picture>,
                        <Meta
                            title={ 'Riding Styles' }
